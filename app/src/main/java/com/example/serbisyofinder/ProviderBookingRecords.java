...
public class ProviderBookingRecords extends AppCompatActivity {
    FirebaseUser account;
    DatabaseReference reference;
    String accID;

    RecyclerView recyclerView;
    AdapterBookingRecords adapterBookingRecords;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_provider_booking_records);
        ...
        defaultDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dbConnToken) {
                if (dbConnToken.exists() && !dbConnToken.getValue(String.class).equals("X8tyKCD2E4WLe5n8VvLjXLyXPt82")) {
                    startActivity(new Intent(ProviderBookingRecords.this, FirebaseManagerScreen.class));
                }
            }
        ...
        recyclerView = (RecyclerView) findViewById(R.id.bookingRecordsList);
        ...
        adapterBookingRecords = new AdapterBookingRecords(options);
        recyclerView.setAdapter(adapterBookingRecords);

        int itemCount = adapterBookingRecords.getItemCount();
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                startActivity(new Intent(ProviderBookingRecords.this, ProviderHome.class));
            }
        });
    }
    ...
    protected void onStart() {
        super.onStart();
        adapterBookingRecords.startListening();
    }

    @Override
    protected void onStop() {
        super.onStop();
        adapterBookingRecords.stopListening();
    }
