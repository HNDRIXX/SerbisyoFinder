...
public class ProviderProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        defaultDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dbConnToken) {
                if (dbConnToken.exists() && !dbConnToken.getValue(String.class).equals("X8tyKCD2E4WLe5n8VvLjXLyXPt82")) {
                    startActivity(new Intent(ProviderProfile.this, FirebaseManagerScreen.class));
                }
            }
        ...
        TextView occupationValue = (TextView) findViewById(R.id.occupationValue);
        TextView mainServiceValue = (TextView) findViewById(R.id.mainServiceValue);
        TextView starRatingsValue = (TextView) findViewById(R.id.starRatingsValue);
        ...
        reference.child(accID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                occupationValue.setText(userProfile.occupation);
                mainServiceValue.setText(userProfile.mainService);
                starRatingsValue.setText(userProfile.starRating);
            }
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ProviderProfile.this, ProviderHome.class));
            }
        });
    }
