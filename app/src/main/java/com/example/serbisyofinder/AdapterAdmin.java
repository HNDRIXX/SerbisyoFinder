...
public class AdapterAdmin extends FirebaseRecyclerAdapter<Account, AdapterAdmin.myViewHolder> {

    public AdapterAdmin(@NonNull FirebaseRecyclerOptions<Account> options) {
        super(options);
    }
