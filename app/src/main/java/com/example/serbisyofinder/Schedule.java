...
public class Schedule {
    public String scheduleID, accID, clientID, mainService, clientPhoneNum, providerPhoneNum, subService, clientName, providerName, clientLatitude, clientLongitude, price, status, rating, review, providerSchedule, clientAddress, flag;

    public Schedule () {

    }

    public Schedule (String scheduleID, String accID, String clientID, String mainService, String clientPhoneNum, String providerPhoneNum, String subService, String clientLatitude, String clientLongitude,String clientName, String rating, String review, String providerName, String price, String status, String providerSchedule, String clientAddress, String flag) {
