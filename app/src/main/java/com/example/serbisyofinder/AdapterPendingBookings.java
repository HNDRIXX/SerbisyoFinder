...
public class AdapterPendingBookings extends FirebaseRecyclerAdapter<Schedule, AdapterPendingBookings.myViewHolder> {

    public AdapterPendingBookings(@NonNull FirebaseRecyclerOptions<Schedule> options ) {
        super(options);
...
//        Toast.makeText(holder.itemView.getContext(), "Item Count: " + getItemCount(), Toast.LENGTH_SHORT).show();

        if(schedule.getFlag().equals("0") || schedule.getFlag().equals("2") || schedule.getFlag().equals("3")){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), ProviderPendingBookingsPanel.class);
